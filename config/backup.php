...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // The app code lives in git + the Docker image, so we only
                    // back up user data: the database (below) and anything the
                    // app writes to storage/app (uploads etc.).
                    storage_path('app'),
                ],
        ...
        'destination' => [
             ...
             */
            'disks' => [
                // Off-site: backups are uploaded to Google Drive so they
                // survive the VPS being lost, not renewed, or rebuilt.
    ...
    'notifications' => [
        'notifications' => [
            // Only notify on problems — no daily "success" spam.
        ...
        'mail' => [
            ...
            // and crashes every artisan command at boot. Set a real address in
            // BACKUP_NOTIFICATION_EMAIL; this placeholder only keeps boot alive.
            'to' => env('BACKUP_NOTIFICATION_EMAIL') ?: 'backups@example.com',
